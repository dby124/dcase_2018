...
feature_storage_path = os.path.join('dcase2018_mfcc_GMM', 'systems', 'ASC_GMM_SIMPLE', 'features')
...
normalization_storage_path = os.path.join('dcase2018_mfcc_GMM', 'systems', 'ASC_GMM_SIMPLE', 'normalization')
...
model_storage_path = os.path.join('dcase2018_mfcc_GMM', 'system_data', 'model')
...
# Define model data storage path
results_storage_path = os.path.join('dcase2018_mfcc_GMM', 'systems', 'ASC_GMM_SIMPLE', 'results')
